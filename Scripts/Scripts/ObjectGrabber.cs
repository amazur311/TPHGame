...
public class ObjectGrabber : MonoBehaviour
{
    ...
    public GameObject doorObjForSceneSave;
    ...
    public void OnTriggerStay(Collider other)
    {
        ...
        if(gameManager.pickUpObjText != null)
        {
            ...
            if(Vector3.Distance(player.transform.position, other.transform.position) <= 2.0f && other.CompareTag("Drawer"))
            {
                gameManager.pickUpObjText.gameObject.SetActive(true);
                gameManager.pickUpObjText.SetText("Open " + other.gameObject.name + "?");

                if (Input.GetKey(KeyCode.E))
                {
                    //gameManager.objPickedUpText.SetText(other.gameObject.name + " Picked Up");
                    other.gameObject.GetComponent<DrawerOpen>().OpenDrawer();
            ...
            {
                doorObjForSceneSave = other.gameObject;
                ...
                {
                    gameManager.pickUpObjText.gameObject.SetActive(true);
                    gameManager.pickUpObjText.SetText("Use Door?");
            ...
            if (Vector3.Distance(player.transform.position, other.transform.position) <= 7.0f && other.CompareTag("RotateDoor"))
            {
                ...
                if(other.GetComponent<DoorRotator>().enabled == true)
                {
                    if (Input.GetKey(KeyCode.E))
                    {
                            ...
                            other.gameObject.GetComponent<DoorRotator>().OpenDoor();
